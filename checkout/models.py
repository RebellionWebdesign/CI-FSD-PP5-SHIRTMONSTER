...
class Order(models.Model):
    ...
    def update_total(self):
        ...
        self.order_total = self.order_items.aggregate(Sum('orderitem_total'))[
        ...
        self.tax = self.order_total * Decimal(settings.TAX_PERCENTAGE)
        self.grand_total = self.order_total + self.shipping_cost + self.tax
        super().save()
